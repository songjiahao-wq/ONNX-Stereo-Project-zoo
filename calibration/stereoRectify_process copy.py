...
class stereoRectify:
    def __init__(self, findChessboardCorners=False):
        ...
        self.world_points[:, :2] = np.mgrid[0:self.board_size[0],
                                   0:self.board_size[1]].T.reshape(-1, 2) * self.square_size
    ...
    def load_calibration_from_json(self, file_path):
        ...
        k_left, dist_left, k_right, dist_right, R, T, Q = calibration_data['k_left'], calibration_data['dist_left'], \
        calibration_data['k_right'], calibration_data['dist_right'], calibration_data['R'], calibration_data['T'], \
        calibration_data['Q']
...
if __name__ == "__main__":
    ...
    if method == 1:
        ...
        # 矫正视频
        left_video_path = r"./data/20250415181831/a0.avi"
        right_video_path = r"./data/20250415181831/a1.avi"
        cap_left = cv2.VideoCapture(left_video_path)
        cap_right = cv2.VideoCapture(right_video_path)
