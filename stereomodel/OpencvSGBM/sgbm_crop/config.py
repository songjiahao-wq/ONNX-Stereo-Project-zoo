...
class CameraIntrinsics:
    ...
    def getIntrinsics640_352(self):
        ...
        baseline = 0.07090622931718826
        return height, width, p, baseline
    def getIntrinsics_AI164_1111(self):
        ...
        left_k, right_k, left_distortion, right_distortion, r, t, q = self.read_calib(r"D:\project2024\stereo matching\ONNX-Stereo-Project-zoo\calibration\cali_circle164_1056x784.json")
        left_k = scale_camera_matrix(left_k, (1056, 784), (640, 480))
        right_k = scale_camera_matrix(right_k, (1056, 784), (640, 480))
...
class Stereo:
    def __init__(self, res_height=480, res_width=640):
        ori_height, ori_width, p, baseline, q, self.map1x, self.map1y, self.map2x, self.map2y  = CameraIntrinsics().getIntrinsics_AI164_1111()
    ...
    def xy_3d_from_crop(self, x_crop, y_crop, crop_offset, depth_map, depth_cam_matrix, depth_scale=1000):
        """从裁剪图像坐标转换为3D坐标"""
        offset_x, offset_y = crop_offset
        x_orig = x_crop + offset_x
        y_orig = y_crop + offset_y
        return self.xy_3d(x_orig, y_orig, depth_map, depth_cam_matrix, depth_scale)
